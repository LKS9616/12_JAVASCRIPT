...
function compare(a, b) {
    ...
    if( a == b ) return 0; // a와 b의 순서를 변경시키지 않음
...
let result = [1, 5, 3, 2, 4].some(item => 10);
console.log(result); // false

let result2 = [1, 5, 3, 2, 4].some(item => 3);
...
console.log('---------- every ------------------');
// Array.prototype.every // 배열 내 일부 요소가 콜백 함수의 테스트를 통과하는지 확인(Boolean 반환)
