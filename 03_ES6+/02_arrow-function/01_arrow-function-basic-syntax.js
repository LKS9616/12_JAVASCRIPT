...
// 화살표함수는 항상 익명함수로 정의된다. 본문이 한줄인 함수를 작성할때 유용
...
// 암묵적으로 반환되기때문에 return 도 생략가능
message = () => "화살표함수 Hello World!";
...
// 객체 리터럴을 반환할 때 함수 물체 부분을 소괄호로 감싸주어야 한다.
...
// 객체로 인식해야 하는 중괄호를 함수 물체 중괄호로 잘못 인식한다.
